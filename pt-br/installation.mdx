---
title: "Instalação"
description: "Instale o zapo-js, escolha um backend de armazenamento e adicione as peer dependencies opcionais que você precisar."
icon: "download"
---
...
<Warning>
  **Enviar mídia requer `@zapo-js/media-utils`.** O pipeline de mídia de saída o usa para sondar e processar a mídia (dimensões, duração, miniaturas, waveforms, normalização de notas de voz) antes do upload, então instale-o sempre que seu app enviar imagens, vídeo, áudio, documentos ou figurinhas.
</Warning>
