...
<Steps>
  ...
  <Step title="Trate o pareamento">
    ...
    <Tip>
      Prefere um **código de pareamento de 8 dígitos** em vez de um QR? Veja [Autenticação](/pt-br/concepts/authentication#pairing-with-a-code).
    </Tip>
  </Step>
...
<CardGroup cols={2}>
  ...
  <Card title="Recebendo mensagens" icon="inbox" href="/pt-br/guides/receiving-messages">
