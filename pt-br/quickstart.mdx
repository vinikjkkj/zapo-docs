---
title: "Início rápido"
description: "Inicie uma sessão zapo, escaneie o QR code do WhatsApp, escute mensagens recebidas e responda seu primeiro chat em poucas linhas de TypeScript."
icon: "rocket"
---
...
<Steps>
  ...
  <Step title="Crie a store e o client">
    A [store](/pt-br/concepts/stores) persiste o estado de auth e do Signal. Aqui usamos SQLite, gravando em `.auth/state.sqlite`.
