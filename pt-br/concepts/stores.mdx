---
title: "Stores"
description: "Persista as credenciais de auth e o estado do protocolo Signal com um backend de store plugável e por domínio — memory, file, Redis ou seu próprio driver."
icon: "database"
---
