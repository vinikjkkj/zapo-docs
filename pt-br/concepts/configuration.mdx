---
title: "Configuração"
description: "Cada campo de WaClientOptions explicado — sessões, timeouts, sincronização de histórico, proxy, logging e tuning para deploys em produção com o zapo."
icon: "sliders"
---
