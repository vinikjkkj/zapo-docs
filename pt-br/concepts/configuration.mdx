---
title: "Configuração"
description: "Cada campo de WaClientOptions explicado — sessões, timeouts, sincronização de histórico, proxy, logging, identidade de browser e os demais botões do zapo."
icon: "sliders"
---
