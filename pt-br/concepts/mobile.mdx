...
description: "Conecte o zapo como um client mobile (Android) primário pelo transporte TCP, em vez do caminho companion multi-dispositivo, incluindo configuração e limitações."
icon: "mobile"
---
