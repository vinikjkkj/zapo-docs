...
description: "Como JIDs de número de telefone (PN) e LIDs de privacidade do WhatsApp diferem, quando cada um aparece em stanzas e como o zapo mapeia entre eles."
icon: "fingerprint"
---
