---
title: "Eventos"
description: "O mapa completo de eventos do WaClient — mensagens, recibos, presença, estado de conexão e app-state — e como assinar atividades de entrada no zapo."
icon: "bell"
---
