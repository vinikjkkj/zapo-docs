---
title: "Introdução"
description: "zapo é uma implementação TypeScript de alta performance do protocolo do WhatsApp Web, construída do zero para cargas de bots e automação em larga escala."
icon: "book-open"
---
