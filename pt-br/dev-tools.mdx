...
description: "Dois pacotes opcionais, apenas para desenvolvimento: um servidor MCP para controlar um WaClient ao vivo a partir de um agente de IA, e um servidor WhatsApp falso in-process para testar sua integração sem tocar no WhatsApp."
