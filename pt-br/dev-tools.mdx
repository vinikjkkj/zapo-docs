...
description: "Dois pacotes opcionais de dev: um servidor MCP que controla um WaClient ao vivo via agente de IA, e um servidor WhatsApp falso in-process para testes."
