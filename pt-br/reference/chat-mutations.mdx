...
description: "Toda operação de client.chat no zapo — os helpers tipados de conveniência e os métodos set e remove genéricos que cobrem todos os schemas de app-state."
icon: "list-check"
---
