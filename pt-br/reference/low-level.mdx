...
description: "O escape hatch bruto — envie nodes de protocolo, faça IQs ao WhatsApp e registre handlers e filtros customizados quando a API de alto nível não basta."
icon: "terminal"
---
