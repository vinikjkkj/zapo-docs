...
description: "Construa e inspecione JIDs do WhatsApp com as funções helper do zapo e consulte cada constante de protocolo WA_* exportada a partir da raiz do pacote."
icon: "at"
---
