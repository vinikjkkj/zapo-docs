...
description: "Opções de configuração para cada pacote de backend de armazenamento do zapo — SQLite, PostgreSQL, MySQL, Redis e MongoDB — incluindo conexão e campos de tuning."
icon: "database"
---
