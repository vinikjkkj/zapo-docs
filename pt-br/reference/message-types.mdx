...
| `image` | `WaSendMediaMessage` | **`media`**, **`mimetype`** | [Mídia](/pt-br/guides/media#images) |
| `video` | `WaSendMediaMessage` | **`media`**, **`mimetype`** | [Mídia](/pt-br/guides/media#video) |
| `ptv` | `WaSendMediaMessage` | **`media`**, **`mimetype`** | [Mídia](/pt-br/guides/media#video) |
| `audio` | `WaSendMediaMessage` | **`media`**, **`mimetype`** | [Mídia](/pt-br/guides/media#audio--voice-notes) |
| `document` | `WaSendMediaMessage` | **`media`**, **`mimetype`** | [Mídia](/pt-br/guides/media#documents) |
| `sticker` | `WaSendMediaMessage` | **`media`** (mimetype opcional) | [Mídia](/pt-br/guides/media#stickers) |
...
| `revoke` | `WaSendRevokeMessage` | **`stanzaId`** | [Revogar](/pt-br/guides/interactive-messages#revoking-delete-for-everyone) |

`target` é um [`WaSendMessageTarget`](/pt-br/guides/interactive-messages#targeting-a-message) (`{ stanzaId, fromMe, participant? }`). Os pais de `poll`/`event` exigem adicionalmente `authorJid` e o `messageSecret` de 32 bytes.
