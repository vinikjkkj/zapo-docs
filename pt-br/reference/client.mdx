...
description: "Referência completa de métodos do WaClient e cada coordinator — message, chat, group, presence, newsletter, profile — baseada no código-fonte do zapo-js."
icon: "code"
---
