...
## Helpers de topo {#top-level-helpers}

Alguns helpers são exportados da raiz do pacote para que você possa chamá-los fora de qualquer coordinator:
...
Para business hours tipados (`WaBusinessHoursDay` / `WaBusinessHoursMode` e as constantes congeladas `WA_BUSINESS_HOURS_DAYS` / `WA_BUSINESS_HOURS_MODES`), veja [Perfil, privacidade & business](/pt-br/guides/profile-privacy#typed-business-hours).
