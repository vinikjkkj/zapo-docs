...
| `mobile` | `WaMobileCoordinator` | [mobile](#mobile) |
...
`WaMobileCoordinator` — veja [Hospedando dispositivos companheiros](/pt-br/concepts/mobile#hosting-companion-devices). Requer uma sessão mobile-primary; métodos de link/revoke/publish lançam em uma conexão Web/companion.
