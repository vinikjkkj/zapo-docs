...
description: "Referência completa de métodos do WaClient do zapo e de cada coordinator — message, chat, group, presence, profile e outros — fundamentada no código-fonte."
icon: "code"
---
