...
description: "Vindo do Baileys? Veja como seus conceitos, eventos e APIs mapeiam para o client baseado em coordinators do zapo, e o que mudar ao portar um bot existente."
icon: "right-left"
---
