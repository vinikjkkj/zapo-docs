...
description: "Crie, descubra, siga, publique, reaja e administre canais (newsletters) do WhatsApp usando o coordinator client.newsletter do zapo em TypeScript."
icon: "newspaper"
---
