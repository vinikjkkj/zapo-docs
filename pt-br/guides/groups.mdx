...
description: "Crie grupos, adicione e remova participantes, gerencie admins, compartilhe links de convite e monte comunidades e subgrupos usando client.group no zapo."
icon: "users"
---
...
const { code, affectedParticipants } = await client.group.revokeInvite(groupJid)
console.log('novo convite:', `https://chat.whatsapp.com/${code}`)
