...
description: "Leia códigos DisconnectReason, trate falhas de stream e stanzas de erro do WhatsApp e decida quando reconectar ou encerrar a sessão de vez no zapo."
