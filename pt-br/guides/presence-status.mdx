...
description: "Transmita presença, envie indicadores de digitação e gravação, assine contatos e publique atualizações de status do WhatsApp com as APIs de presença do zapo."
icon: "circle-dot"
---
