---
title: "Reconexão"
description: "O zapo não reconecta automaticamente. Veja o padrão recomendado para detectar conexões perdidas, aplicar backoff e voltar a sessão para o ar com segurança."
icon: "arrows-rotate"
---
