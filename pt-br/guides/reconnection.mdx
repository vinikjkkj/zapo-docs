---
title: "Reconexão"
description: "O zapo não reconecta automaticamente — aqui está o padrão para lidar com conexões perdidas."
icon: "arrows-rotate"
---
...
O estado persistido (credenciais, sessões do Signal, app-state) é restaurado da [store](/pt-br/concepts/stores) automaticamente — você **não** pareia novamente em uma reconexão normal.
