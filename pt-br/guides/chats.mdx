...
description: "Mute, fixe, arquive, marque como lido, trave, favorite, limpe e delete chats do WhatsApp com o coordinator tipado client.chat e mutações de app-state."
icon: "comments"
