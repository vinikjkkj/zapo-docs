...
description: "Faça o parse dos eventos de mensagens recebidas do WhatsApp com o zapo — extraia texto, mídia e citações, envie recibos de entrega e leitura, e trate addons."
icon: "inbox"
---
