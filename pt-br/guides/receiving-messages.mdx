...
description: "Faça parse de eventos de mensagens recebidas do WhatsApp, extraia texto e mídia, envie recibos de entrega e leitura e trate addons como reações e edições."
icon: "inbox"
---
