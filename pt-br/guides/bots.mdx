---
title: "Bots"
description: "Descubra bots do WhatsApp, envie prompts e receba respostas em stream com o zapo. Funciona com qualquer bot do WhatsApp, incluindo Meta AI e terceiros."
icon: "robot"
---
...
| Campo | Significado |
| --- | --- |
| `key.participant` / `key.remoteJid` | O bot (sender = `key.participant ?? key.remoteJid`). |
