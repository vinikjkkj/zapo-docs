...
O `client.bot` ([`WaBotCoordinator`](/pt-br/reference/client#bot-email-broadcastlist)) funciona com **bots** do WhatsApp - qualquer conta no domínio `@bot`. O Meta AI é o mais comum, mas **não** é o único bot; `listBots()` retorna todos os bots disponíveis para a sua conta. O coordinator descobre bots, lê seus perfis, envia prompts e descriptografa os chunks em **stream** da resposta de um bot.
