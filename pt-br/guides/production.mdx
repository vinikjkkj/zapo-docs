...
description: "Rode o zapo de forma confiável em produção — persistência de store, shutdown gracioso, escalar várias sessões do WhatsApp, observabilidade e tuning."
icon: "server"
---
