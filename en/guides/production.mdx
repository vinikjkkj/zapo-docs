...
description: "Run zapo reliably in production — store persistence, graceful shutdown, scaling many WhatsApp sessions, observability, and the config knobs that matter."
icon: "server"
---
