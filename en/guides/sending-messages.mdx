...
description: "Send WhatsApp text, threaded replies, mentions, and rich link previews with client.message.send, the typed entry point for all outgoing content."
icon: "paper-plane"
---
...
Content types without a typed builder yet — locations, contact vCards, and Business PIX / review-and-pay payment cards — are documented in [Raw proto sends](/en/guides/raw-sends).
