...
description: "Mute, pin, archive, mark read, lock, star, clear, and delete WhatsApp chats with the client.chat coordinator and zapo's typed app-state mutations."
icon: "comments"
