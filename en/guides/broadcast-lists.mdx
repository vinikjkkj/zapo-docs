...
description: "Define a WhatsApp broadcast list with zapo and send a single message to many recipients at once without creating a group or revealing the list."
icon: "bullhorn"
---
