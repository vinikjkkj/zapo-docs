...
description: "Create and manage WhatsApp groups and communities with zapo — participants, admins, invite links, settings, and parent-community linking via client.group."
icon: "users"
---
