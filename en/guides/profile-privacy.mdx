...
description: "Manage your WhatsApp profile picture and about text, control privacy settings and the blocklist, and read business profiles with zapo's typed APIs."
icon: "id-card"
---
