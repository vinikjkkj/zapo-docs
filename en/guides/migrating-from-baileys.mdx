...
description: "Coming from Baileys? See how its concepts, events, and APIs map onto zapo's coordinator-based client, and what to change when porting an existing bot."
icon: "right-left"
---
