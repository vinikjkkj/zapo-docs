---
title: "Recipes"
description: "Copy-paste patterns for the most common things you'll build with zapo — command bots, media handling, threaded replies, and group moderation tasks."
icon: "book-bookmark"
---
