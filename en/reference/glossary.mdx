---
title: "Glossary"
description: "Definitions of WhatsApp protocol and zapo-specific terms used throughout the docs — JID, LID, stanza, store, coordinator, app-state, fanout, and more."
icon: "book"
