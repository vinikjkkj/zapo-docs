...
description: "Complete method reference for WaClient and every coordinator, grounded in the source."
icon: "code"
---
...
| `setSetting` | `(groupJid, setting, enabled) => Promise<void>` | Toggle a boolean group flag (`announce`, `restrict`, `ephemeral`, `group_history`, `allow_admin_reports`, `no_frequently_forwarded`, community flags). |
