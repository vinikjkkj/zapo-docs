...
description: "Complete method reference for zapo's WaClient and every coordinator — message, chat, group, presence, profile, and more — grounded in the library source."
icon: "code"
---
