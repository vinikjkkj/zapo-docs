---
title: "Low-level API"
description: "zapo's raw escape hatch — send WhatsApp XMPP nodes, issue IQ requests, and register custom incoming-node handlers and filters when coordinators fall short."
icon: "terminal"
---
