...
description: "Every client.chat operation in zapo — the typed convenience helpers and the generic set and remove methods that cover all WhatsApp app-state schemas."
icon: "list-check"
---
