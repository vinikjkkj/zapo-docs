...
description: "Connect zapo as a primary mobile (Android) client over the TCP transport instead of the multi-device companion path, including setup and limitations."
icon: "mobile"
---
