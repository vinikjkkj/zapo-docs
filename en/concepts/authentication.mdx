...
description: "Pair a WhatsApp device with a QR code or 8-character pairing code, persist Signal credentials across restarts, and cleanly log out a session."
icon: "qrcode"
---
