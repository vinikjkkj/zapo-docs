---
title: "Stores"
description: "Persist authentication credentials and Signal protocol state with a pluggable, per-domain store backend — memory, file, Redis, or your own driver."
icon: "database"
---
