...
description: "Answers to the most common questions and pitfalls when running zapo — pairing failures, missing messages, store errors, and other connection issues."
