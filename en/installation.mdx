---
title: "Installation"
description: "Install zapo-js, choose a storage backend, and add the optional peer dependencies you need."
icon: "download"
---
...
<Warning>
  **Sending media requires `@zapo-js/media-utils`.** The outbound media pipeline uses it to probe and process media (dimensions, duration, thumbnails, waveforms, voice-note normalization) before upload, so install it whenever your app sends images, video, audio, documents, or stickers.
</Warning>
