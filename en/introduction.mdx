---
title: "Introduction"
description: "zapo is a high-performance TypeScript implementation of the WhatsApp Web protocol, built from scratch for high-scale, multi-session bot workloads."
icon: "book-open"
---
