...
description: "Two optional dev packages: an MCP server that drives a live WaClient from an AI agent, and an in-process fake WhatsApp server for testing integrations."
