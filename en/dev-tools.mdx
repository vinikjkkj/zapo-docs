...
description: "Two optional, development-only packages: an MCP server to drive a live WaClient from an AI agent, and an in-process fake WhatsApp server to test your integration without touching WhatsApp."
